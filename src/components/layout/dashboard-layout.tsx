  ...
  return (
    <div className="min-h-screen bg-gray-50 flex" onKeyDown={handleKeyDown}>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        {/* Header */}
        <header className="bg-white px-4 sm:px-6 lg:px-8 py-3 sm:py-[13px] my-[5px]">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-4 flex-shrink-0">
              ...
              <div className="rounded-[50%] bg-gray-300 flex items-center justify-center">
                <img className='w-8 h-8 sm:w-10 sm:h-10 object-cover object-center rounded-[50%]' src="/assets/dashboard/adminImg.jpg" alt="admin" />
              </div>
            </div>
          </div>
        </header>
        ...
        {/* Content Area */}
        <main className="flex-1 pt-3 sm:pt-5 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8">
          {children}
        </main>
      </div>
    </div>
